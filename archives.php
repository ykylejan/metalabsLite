                            ...
                            <div class="flex items-center p-20 text-center bg-gray-50">
                                <div class="flex flex-col w-full max-w-sm px-4 mx-auto">
                                    <div class="p-3 mx-auto text-blue-500 bg-blue-100 rounded-full">
                                        ...
                                        <lord-icon src="https://cdn.lordicon.com/vuiggmtc.json" trigger="in" colors="primary:#3080e8" style="width:32px;height:25px">
                                        </lord-icon>
                                    </div>
                                    <h1 class="mt-3 text-lg text-gray-800">No students archived</h1>
                                    <p class="mt-2 text-gray-500">Your archives table does not have any records at the moment...</p>
